...
public class ExtractionWindow {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ExtractionWindow window = new ExtractionWindow();
	...
	private void initialize() {
		...
		frmv.setTitle("GraphicDetector-v1.0");
		...
		Extraction.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String projectDir = "main.java.javaextractor.JavaExtractor: "+projectDirectory.getText()+"\\src";
				try {
